...
export const repoLocalWorkItems = {
  ...
  'OPERATE-SPEC-013': {
    ...
    skills: 'docs/implementation/operating-board.md',
    marketplace: 'docs/implementation/OPERATE-SPEC-013.md',
  },
  'OPERATE-SPEC-012': {
    pipeline: 'docs/implementation/operating-board.md',
  ...
  'OPERATE-SPEC-011': {
    ...
    skills: 'docs/implementation/operating-board.md',
    marketplace: 'docs/implementation/OPERATE-SPEC-011.md',
  },
  'SPEC-002': {
    pipeline: 'docs/implementation/operating-board.md',
    cli: 'docs/implementation/OPERATE-SPEC-002.md',
  ...
  'OPERATE-SPEC-009': {
    pipeline: 'docs/implementation/operating-board.md',
    cli: 'docs/implementation/OPERATE-SPEC-009.md',
    skills: 'docs/implementation/operating-board.md',
    marketplace: 'docs/implementation/OPERATE-SPEC-009.md',
  },
  'OPERATE-SPEC-010': {
    pipeline: 'docs/implementation/operating-board.md',
    cli: 'docs/implementation/OPERATE-SPEC-010.md',
    skills: 'docs/implementation/operating-board.md',
    marketplace: 'docs/implementation/OPERATE-SPEC-010.md',
  },
};
