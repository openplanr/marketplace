...
|---|---|---|
| [`planr`](https://github.com/openplanr/OpenPlanr/tree/openplanr@2.2639.0/packages/cli) | 2.2639.0 | Host-native OpenPlanr planning, delivery, review, design, and operating skills. Generated from [`openplanr@2.2639.0`](https://www.npmjs.com/package/openplanr/v/2.2639.0). |
<!-- plugin-table:end -->
...
|---|---:|---|
| OpenPlanr CLI | 1.25.3 | pipeline ^0.42.0 |
| Pipeline package/plugin | 0.42.0 | CLI ^1.25.3 |
...
Resolved component versions: pipeline 0.42.0, CLI 1.25.3, skills 1.26.2, marketplace 1.14.0.
