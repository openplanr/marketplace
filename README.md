...
|---|---|---|
| [`planr-pipeline`](https://github.com/openplanr/planr-pipeline) | 0.8.0 | Spec-driven AI factory with 8 subagents and tool-layer rule enforcement. Canonical Claude Code adapter for [OpenPlanr Protocol v1.0.0](https://github.com/openplanr/planr-pipeline/tree/main/docs/protocol); same workflow runs on Cursor + Codex via `planr rules generate --scope pipeline`. |
| [`openplanr`](https://github.com/openplanr/skills) | 1.5.0 | OpenPlanr skill — multi-runtime routing playbook teaching Claude when to use which surface (Path A: Claude Code, A2: Cursor, A3: Codex, B: skill-driven, C: bare CLI). |
