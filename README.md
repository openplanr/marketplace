...
|---|---:|---|
| OpenPlanr CLI | 1.25.1 | pipeline ^0.41.0 |
| Pipeline package/plugin | 0.41.0 | CLI ^1.25.1 |
| Runtime skills | 1.26.1 | CLI ^1.25.1 |
...
|---|---|---|
| [`planr-pipeline`](https://github.com/openplanr/planr-pipeline) | 0.41.0 | Complete PO, Design, Review, DEV, and QA workflow with universal HTML artifact review and private sharing. |
| [`openplanr`](https://github.com/openplanr/skills) | 1.26.1 | Unified operating, planning, artifact review, and delivery workflow skills for the certified runtimes. |
<!-- plugin-table:end -->
...
Resolved component versions: pipeline 0.41.0, CLI 1.25.1, skills 1.26.1, marketplace 1.13.0.
