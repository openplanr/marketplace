...
The guided capability stays unavailable until pipeline `0.31.0`, OpenPlanr
`1.15.0`, skills `1.17.0`, marketplace `1.2.0`, exact repository revisions,
CI, packages/tags, and runtime canaries reconcile. Before publication each
